...
export default function RecyclerRegistration() {
  const {
    register,
    handleSubmit,
    formState: { errors },
  ...
  const onSubmit = () => {
    ...
    try {
      axios.post("http://localhost:9090/auth/registerRecycler", formDataDto).then(response => {
  ...
  return (
    <Helmet title="Recycler - Registration Page">
      <Container>
